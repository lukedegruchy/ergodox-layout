 ...
 *
 * ,-----------------------------------------------------.           ,-----------------------------------------------------.
 * | SHIFT+INS | 1  ! | 2  @ | 3  # | 4  $ | 5  % |GUI+LT|           |GUI+RT| 6  ^ | 7  & | 8  * | 9  ( | 10 ) |   DEL     |
 * |-----------+------+------+------+------+-------------|           |------+------+------+------+------+------+-----------|
 ...
 *
 * ,-----------------------------------------------------.           ,-----------------------------------------------------.
 * | CTRL+INS  |  F1  |  F2  |  F3  |  F4  |  F5  |      |           |      |  F6  |  F7  |  F8  |  F9  |  F10 |    F11    |
 * |-----------+------+------+------+------+-------------|           |------+------+------+------+------+------+-----------|
 * |           |   `  |   @  |   {  |   }  |   |  |      |           |      |   *  |   7  |   8  |   9  |   &  |    F12    |
 * |-----------+------+------+------+------+------|      |           |      |------+------+------+------+------+-----------|
 * |           |   #  |   $  |   (  |   )  |   &  |------|           |------|   +  |   4  |   5  |   6  |   _  |           |
 ...
 */
  [SYMB] = LAYOUT_ergodox(
            // left hand
             LCTL(KC_INSERT),      KC_F1,          KC_F2,          KC_F3,          KC_F4,      KC_F5,      KC_TRANSPARENT,
